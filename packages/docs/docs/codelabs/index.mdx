...
<CodelabGrid>
  ...
  <CodelabCard
    level="Advanced"
    title="Build a custom mutator"
    href="/codelabs/custom-mutator/codelab-overview">
    <Image
      alt="Two 'resizable list with' blocks: the first with two filled inputs, the second with the same two filled inputs and an empty third input"
      src="/images/codelabs/card_thumbnails_custom-mutator.png"
      srcDark="/images/codelabs/card_thumbnails_custom-mutator-dark.png"
    />
  </CodelabCard>
</CodelabGrid>
