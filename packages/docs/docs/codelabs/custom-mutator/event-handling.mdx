...
Effectively, all of these events are part of the same process: the block 
mutation. The solution for this is grouping all of the mutation events together 
in one event group. Setting an event group at the beginning of the mutation 
means that the whole mutation will be one action in the undo/redo stream. 
