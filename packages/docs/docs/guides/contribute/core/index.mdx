...
- PR summaries and comments should be human written, and AI usage is not allowed 
  on issues labeled `good first issue`. Consult the [AI policy](/guides/contribute/core/ai_policy)
