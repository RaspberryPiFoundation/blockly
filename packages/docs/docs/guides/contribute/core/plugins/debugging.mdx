...
TODO: This should be able to be deleted once NX is fully set up. Leaving here for now, because there could still maybe be special instructions after nx is set up 
