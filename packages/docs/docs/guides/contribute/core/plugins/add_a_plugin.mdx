...
Next, a plugin goes into the **discussion** phase. This phase generally occurs 
on the GitHub issue, and includes:

- Clarification of the desired functionality and the plugin's API.
