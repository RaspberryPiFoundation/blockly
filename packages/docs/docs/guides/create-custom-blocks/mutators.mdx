...
select the block shape that they want. Blockly's builtin MutatorIcon class will 
allow you to add a mutator UI to your block, 

including a clickable icon which 
opens the mutator UI in a bubble. 

 ** what does "certain functions" mean?? **
